# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-10-03 22:45
...
def do_stuff(apps, schemd_editor):
    ...
    for curPage in Pages:
        ...
        boxes = DetectedCombinedBox.filter(demonstration=True)
        box_to_review = []
        for box in boxes:
        ...
        for box in box_to_review:
            ...
            if box.id_num not in box_removed_from_review:
                ...
                max_search_distance = max(box.y2 - box.y1, box.x2 - box.x1)
                keep_going = True
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('calligraphy', '0223_auto_20171003_2232'),
    ]
