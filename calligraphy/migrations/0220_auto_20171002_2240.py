# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-10-02 22:40
...
def do_stuff(apps, schemd_editor):
    ...
    for curPage in Pages:
        ...
        boxes = DetectedCombinedBox.filter(parent_page=curPage, based_on_no_predictor=True)
        box_to_review = []
        for box in boxes:
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('calligraphy', '0219_auto_20171002_2240'),
    ]
