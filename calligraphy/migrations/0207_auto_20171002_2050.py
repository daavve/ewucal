# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-10-02 20:50
...
def do_stuff(apps, schemd_editor):
    ...
    for curPage in Pages:
        ...
        boxes = DetectedCombinedBox.filter(parent_page=curPage, based_on_bad_predictor=True)
        box_to_review = []
        for box in boxes:
        ...
        for box in box_to_review:
            if box.id_num not in box_removed_from_review:
                max_search_distance = int(max(box.y2 - box.y1, box.x2 - box.x1) / 4)
                keep_going = True
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('calligraphy', '0206_auto_20171002_2050'),
    ]
