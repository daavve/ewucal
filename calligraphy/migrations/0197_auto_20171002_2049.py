# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-10-02 20:49
...
def do_stuff(apps, schemd_editor):
    ...
    for curPage in Pages:
        ...
        box_dict = dict()
        for box in DetectedCombinedBox.filter(parent_page=curPage, based_on_bad_predictor=True):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('calligraphy', '0196_auto_20171002_2049'),
    ]
