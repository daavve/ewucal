...
def do_stuff(apps, schemd_editor):
    ...
    Pages = [ apps.get_model('calligraphy', 'Page').objects.get(id=19988) ]
    ...
    for curPage in Pages:
        ...
        for box in box_dict:
            ...
            DetectedCombinedBox(parent_page=curPage,
                                ...
                                x1=box_cur.x1,
                                x2=box_cur.x2,
                                based_on_good_predictor = True,
                                based_on_bad_predictor = False,
                                based_on_no_predictor = False,
                                demonstration = True).save()

class Migration(migrations.Migration):

    dependencies = [
        ('calligraphy', '0221_detectedcombinedbox_demonstration'),
    ]
